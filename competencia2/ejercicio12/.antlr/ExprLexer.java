...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PUBLIC", "CLASS", "IDF", "LLAVE_IZQ", "STRING", "STATIC", "ARGS", "VOID", 
			"MAIN", "PARENTESIS_IZQ", "PARENTESIS_DER", "MAYOR", "MENOR", "INT", 
			"IGUAL", "NUM", "PUNTO_COMA", "LLAVE_DER", "CORCHETE_IZQ", "CORCHETE_DER", 
